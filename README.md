...
<a name="логические-аспекты"></a>
 ...
 При распознавании команды `/start` бот здоровается с пользователем и предлагает либо отправить ему день недели, либо посмотреть полный список команд нажав на `/list`. 
