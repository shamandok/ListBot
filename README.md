...
### Логические аспекты
 ...
 Но, как мы знаем, бот умеет реагировать не только на команды, но и на обычные текстовые запросы, о чем он нам говорит ещё в само начале работы с ним.
 
 Здесь все проще: при получении сообщения с днем недели, бот присылает расписание занятий на этот день.
## Выбор технологий
